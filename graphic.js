...
$(document).ready(function(){
    ...
    ExtractDacaFromNodeRed(locatedId);
        ...
        function ExtractDacaFromNodeRed(locatedId) {
            let loc = GetRequestParam("loc");
            $.ajax ({
                url: addr + '?loc='+loc,
                type: 'GET', 
                ...
                let checkIfAreThere = 0,
                    ...
                    dataChart = [ 30, 35, 40, 45, 50, 55, 60, 65], // start with 0 minutes.
                    ...
                    getTargetNumber = Number(data.target);
                        ...
                        var options = {
                            ...
                            chart: {
                                id: Object.keys(data.checkpoints[i]),
                                height: 350,
                                type: 'line',
                                dropShadow: {
                                    enabled: true,
                                ...
                                brush: {
                                    target: Object.keys(data.checkpoints[i]),
                                    enabled: true
                                },
                                toolbar: {
                                    show: false
                            ...
                            title: {
                                text: `${titleObj}` + ` - last update (${checkUpdate()})`,
                                align: 'center'
                            },
                            grid: {
                                borderColor: '#e7e7e7',
